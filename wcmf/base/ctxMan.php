...
class ctxMan {
	...
	function getFile($label, $path, $obj = null) {
	...
	function getFiles($label, $path, $obj = null) {
		$rres = $this->findFilesByLabel($label);
	...
	function findFilesByLabel($label) {
